...
<body>
				...
				<ul class="nav ace-nav">
					...
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						class="dropdown-toggle"> <img class="nav-user-photo"
							...
							class="user-info"> <small>欢迎光临,</small> 卓轩
	...
	<div class="main-container" id="main-container">
		...
		<div class="main-container-inner">
		 	...
		 	<!-- 引入系统菜单栏 -->
			<jsp:include page="common/system_menu.jsp"  /> 
			...
			<div class="main-content">
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<!-- #nav-search -->
				     ...
				     <!-- 主工作区 workcenter -->
					 <iframe style="border: 0px;width: 100%;height: 600px;"  frameborder="0" scrolling="auto"  id="workcenter" name="workcenter"></iframe>

			 
			 

				<!-- 引入设置样式的工具栏 -->
				<jsp:include page="common/setings_container.jsp"  /> 
