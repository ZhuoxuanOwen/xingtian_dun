	...
	<div class="main-container" id="main-container">
		<div class="page-content">
			...
			<div class="row col-xs-12">
				<div class="col-sm-6">
					<button class="btn btn-primary" onclick="return regDatabase();">注册MongoDB资源</button>
			...
			<div class="row col-xs-12" style="margin-top: 10px;">
				...
				<div class="table-responsive">
					<table id="sample-table-1"
						...
						<tbody>
							<s:iterator  value="mongodbList" id="db">
								<tr>
									<td class="center"><label> <input type="checkbox"
											class="ace" id="<s:property value="databaseId"/>" /> <span class="lbl"> 
										</span>
									</label></td>
									...
									<td>
										...
										<s:elseif test="%{#db.dbStatus==4}">
											<button  class="btn btn-xs btn-danger"  onclick="initDatabase(<s:property value="databaseId"/>)" >
...
<!-- 											</button> -->
											...
											<button  class="btn btn-xs btn-info"  onclick="initDatabase(<s:property value="databaseId"/>)" >
												<i class="icon-cogs bigger-120"></i>
											</button>

											<button  class="btn btn-xs btn-warning" onclick="initTableList(<s:property value="databaseId"/>)"   >
