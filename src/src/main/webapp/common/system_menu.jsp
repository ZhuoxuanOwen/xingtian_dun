...
<div class="sidebar" id="sidebar">
	...
	<ul class="nav nav-list">
		...
		<li><a href="#" class="dropdown-toggle"> <i
				class="icon-desktop"></i> <span class="menu-text"> 数据&运维 </span> <b
			...
			<ul class="submenu">
				...
				<li><a href="<%=path%>/resource/mongodbList.action"> <i
						class="icon-double-angle-right"></i> MongoDB
				</a></li>

				<li><a href="nestable-list.html"> <i
						class="icon-double-angle-right"></i> Redis 缓存
				</a></li>
		...
		<li><a href="#" class="dropdown-toggle"> <i class="icon-list"></i>
				<span class="menu-text">开发集成 </span> <b
				class="arrow icon-angle-down"></b>
		</a>
		...
		<li><a href="#" class="dropdown-toggle"> <i
				class="icon-picture"></i> <span class="menu-text"> 常用工具 </span> <b
				class="arrow icon-angle-down"></b>
		</a>

			<ul class="submenu">
				<li><a href="tables.html"> <i
						class="icon-double-angle-right"></i> ID-URL 转换
				</a></li>
